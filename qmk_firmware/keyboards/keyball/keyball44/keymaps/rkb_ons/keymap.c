...
// +----------+----------+----------+----------+----------+----------+                                              +----------+----------+----------+----------+----------+----------+
    KA_ESC_L  ,KC_Q      ,KC_L      ,KC_U      ,KC_COMM   ,KC_DOT    ,                                               KC_F      ,KC_W      ,KC_R      ,KC_Y      ,KC_P      ,JP_SLSH   ,
// +----------+----------+----------+----------+----------+----------+                                              +----------+----------+----------+----------+----------+----------+
    KA_TAB_L  ,KC_E      ,KC_I      ,KC_A      ,KC_O      ,KC_MINS   ,                                               KC_K      ,KC_T      ,KC_N      ,KC_S      ,KC_H      ,JP_2      ,
// +----------+----------+----------+----------+----------+----------+                                              +----------+----------+----------+----------+----------+----------+
    KC_LSFT   ,KC_Z      ,KC_X      ,KC_C      ,KC_V      ,JP_SCLN   ,                                               KC_G      ,KC_D      ,KC_M      ,KC_J      ,KC_B      ,JP_1      ,
// +----------+----------+----------+----------+------+---+------+---+------+----------+          +----------+------+---+------+----------+----------+----------+----------+----------+
...
// +----------+----------+----------+----------+----------+----------+                                              +----------+----------+----------+----------+----------+----------+
    KC_F1     ,KC_F2     ,KC_F3     ,KC_F4     ,_______   ,_______   ,                                               JP_GRV    ,JP_LCBR   ,JP_RCBR   ,JP_LBRC   ,JP_RBRC    ,JP_AT     ,
// +----------+----------+----------+----------+----------+----------+                                              +----------+----------+----------+----------+----------+----------+
    _______   ,KC_F5     ,KC_F6     ,KC_F7     ,KC_F8     ,_______   ,                                               JP_DQUO   ,JP_HASH   ,JP_AMPR   ,JP_CIRC   ,JP_YEN    ,_______   ,
// +----------+----------+----------+----------+----------+----------+                                              +----------+----------+----------+----------+----------+----------+
    _______   ,KC_F9     ,KC_F10    ,KC_F11    ,KC_F12    ,_______   ,                                               JP_QUOT   ,JP_SLSH   ,JP_DLR    ,JP_LABK   ,JP_RABK   ,_______   ,
// +----------+----------+----------+----------+------+---+------+---+------+----------+          +----------+------+---+------+----------+----------+----------+----------+----------+
                          _______   ,_______   ,       _______   ,_______   ,_______   ,           _______   ,_______   ,                                        _______
//                       +----------+----------+      +----------+----------+----------+          +----------+----------+                                       +----------+
  ),
